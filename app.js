System.register(['@angular/core', '@angular/platform-browser', "@angular/platform-browser-dynamic"], function(exports_1, context_1) {
    ...
    var Product, ProductDepartment, PriceDisplay, ProductImage, ProductRow, ProductsList, InventoryApp, InventoryAppModule;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            InventoryApp = (function () {
                function InventoryApp() {
                    this.products = [
                        ...
                        new Product('NEATOJACKET', 'Blue Jacket', '/resources/images/products/blue-jacket.jpg', ['Women', 'Apparel', 'Jackets & Vests'], 239.99),
